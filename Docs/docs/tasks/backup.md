...
To do a manual backup, go to the **Settings** page and expand the **Backups** 
section. Click **Backup Now...** Select a location for the backup and click Save.
...
To setup automatic backups, go to the **Settings** page and expand the **Backups** 
section. Select the **Automatic** radiobutton under **Backups**. Click the **...** 
button beside **Backup Location** and select a location to save the backups in, such as
...
To restore a backup, go to the **Settings** page and expand the **Backups** section. 
Click **Restore from backup...**. Choose the backup file to restore from, and confirm 
that you want to restore the backup. The application will close. Open it again and 
