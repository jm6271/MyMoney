...
; NOTE: This script uses relative paths to the binary files.
; It must be run from the repo root folder

#define MyAppName "MyMoney"
#define MyAppVersion "0.10.2-beta"
...
OutputDir=.
OutputBaseFilename=mymoney-setup-0.10.2-win-arm64
Compression=lzma
...
[Files]
Source: "MyMoney\bin\Release\net9.0-windows\win-arm64\publish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
